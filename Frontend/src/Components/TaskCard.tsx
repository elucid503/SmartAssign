...
const TaskCard: React.FC<TaskCardProps> = ({ Task, OnDelete, OnStatusChange, OnClick }) => {
  ...
  return (
    ...
    <div onClick={OnClick} className="card hover:shadow-lg transition-shadow cursor-pointer border-l-4 border-primary-500">
      ...
      <div className="flex items-start justify-between">
        ...
        <div className="flex items-start space-x-3 flex-1">
          ...
          <div className="flex-1">
            ...
            <div className="flex items-center space-x-3 mt-3">
              ...
              {Task.EstimatedTime && (<span className="text-xs text-gray-500 dark:text-gray-400"> ~{Task.EstimatedTime} min </span>)}
              
              {Task.Category && (<span className="text-xs bg-gray-100 dark:bg-gray-700 px-2 py-1 rounded"> {Task.Category} </span>)}
        ...
        <button onClick={HandleDelete} className="text-red-500 hover:text-red-700 ml-4"> <Trash2 className="w-5 h-5"/> </button>
